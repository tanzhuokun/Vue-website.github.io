    ...
    <ul class="ul-header border-1px">
      ...
      <div class="left-menu" v-show="getGlobalInfo.isHigher768">
          <router-link class="logo" tag="a" to="/home">
            <!-- <img width="36" height="36" :src="home" title="谭卓昆个人网站" alt=""> -->
          </router-link>
          <router-link tag="a" to="/home">
            <li>首页</li>
          </router-link>
          <a href="http://www.fanjiani.club" target="_black">
            <li>博客</li>
          </a>
          ...
          <a href="https://translate.google.cn/?hl=en" target="_black"><li>谷歌翻译君</li></a>
